...
<!-- 
 ...
 -->
				<table style="width: 800px; margin: 0 auto">
					...
					<tr>
						<td><input type="text" style="width: 767px" name="recRTitle" placeholder="제목"></td>
					</tr>
						...
						<td><input type="hidden" style="width: 767px" value="작성자">
							...
							<div class="contwrite">
						        <div class="col">
	            					<dl>
	    								<dt>나이</dt>
	    								<dd><strong><input type="text" name="age" value="AGE"></strong></dd>
									</dl>
	            					<dl>
	    								<dt>성별</dt>
	    								<dd><strong><input type="text" name="gender" value="GENDER"></strong></dd>
									</dl>
	            					<dl>
	    								<dt>경력</dt>
	    								<dd><strong><input type="text" name="recCareer" value="REC_CAREER"></strong></dd>
									</dl>
									<dl>
	    								<dt>학력</dt>
	    								<dd><strong><input type="text" name="education" value="EDUCATION"></strong></dd>
									</dl>
									<dl>
	        							<dt>근무형태</dt>
	        							<dd><strong><input type="text" name="recType" value="REC_TYPE"></strong></dd>
								    </dl>
								</div>
								<div class="col">
					                <dl>
		                			...
		                			<dl>
		        						<dt>직급/직책</dt>
		        						<dd><input type="text" name="position" value="POSITION"></dd>
		    						</dl>
		                            <dl>
		        						<dt>근무지역</dt>
		        						<dd><input type="text" name="region" value="REGION"></dd>
		    						</dl>
		                            <dl>
		        						<dt>모집인원</dt>
		        						<dd><input type="text" name="recNumber" value="REC_NUMBER"></dd>
		    						</dl>
		                            <dl>
		        						<dt>모집기한</dt>
		        						<dd><input type="text" name="period" value="PERIOD"></dd>
		    						</dl>		    						
		        				</div>
			           		 </div>
					...
					<tr>
						<td style="text-align:right;"><button type="button" id="uploadRecruit" class="btn btn-outline-success">공고 등록</button>&nbsp;
