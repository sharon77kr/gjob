								...
								<table>
									<tr>
										<td rowspan="3" id="profileTd">
											<div class="input-group" id="profileImg" style="background-image: url('/goottjobplanet/resources/upload-files/${ resume.profile }')"></div>
...
<%-- 									<tr>
									...
									<tr>
										...
										<td colspan="2" id="i1noSection"><select name="i1no" id="i1no">
												<option value="${ industry.i1no }" selected="selected">${ industry.industry1 }</option>
												<c:forEach items="${ industries1 }" var="industry1">
													<option value="${ industry1.i1no }">${ industry1.industry1 }</option>
												</c:forEach>
										</select></td>
										<td colspan="3" id="i2noSection"><select name="i2no" id="i2no">
												<option value="${ resume.i2no }" selected="selected">${ industry.industries2[0].industry2 }</option>
										</select></td>
						...
						<div class="col-md-12">
							<div class="input_field">
								<input type="text" name="license" id="license" placeholder="자격증" value="${ resume.license }">
							</div>
						</div>				
						...
						<div class="col-md-12">
							<div class="input_field">
								...
								<input type="text" name="academic" id="academic"
									placeholder="학력 사항" value="${ resume.academic }">
							</div>
						</div>
						<div class="col-md-12">
							<div class="input_field">
								<textarea name="rcareer" id="rcareer" cols="30" rows="10"
									placeholder="경력 사항">${ resume.rcareer }</textarea>
							</div>
						</div>
						<div class="col-md-12">
							<div class="input_field">
								<textarea name="prize" id="prize" cols="30" rows="10"
									placeholder="수상 내역">${ resume.prize }</textarea>
							</div>
						</div>
						<div class="col-md-12">
							<div class="input_field">
								<textarea name="intro" id="intro" cols="30" rows="10"
									placeholder="자기 소개">${ resume.intro }</textarea>
							</div>
						</div>
						<div class="col-md-4">
							...
							<div class="switch-wrap d-flex justify-content-between">
								...
								<div class="primary-checkbox">
									<c:choose><c:when test="${ resume.ptype ne true }">
						...
						<div class="col-md-4">
							<div class="submit_btn">
								<button class="boxed-btn3 w-100" id="complete" type="button">수정 완료</button>
