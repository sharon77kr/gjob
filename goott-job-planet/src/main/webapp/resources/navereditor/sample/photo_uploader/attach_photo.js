    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/goottjobplanet/recruit/galleryimageupload2'; 	//upload URL
...
//    	 }
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			...
 			sUrl  : '/goottjobplanet/recruit/galleryimageupload',
 			sCallback : '/resources/navereditor/sample/photo_uploader/callback.html',
